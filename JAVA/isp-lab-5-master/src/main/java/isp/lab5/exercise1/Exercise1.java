...
class Bank{
    ...
    public Account getAccountByCardId(String id){
        for(int i=0; i<10; i++){
            if(account[i].getCard().getCardId().equals(id)){
                return account[i];
            }
        }
        return null;
...
public class Exercise1 {
    ...
    public static void main(String[] args) {
        ...
        Card c17 = new Card("12345","0000");
        Account a17 = new Account("Razvan",1000, c17);
        ...
        bank.addAccount(a1); bank.addAccount(a17);
        
        System.out.println("\n----------------");
        bank.executeTransaction(new CheckMoney( a1));
